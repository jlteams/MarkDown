...
final class EditorViewModel: ObservableObject {
    ...
    func openFile(at url: URL) {
        ...
        print("📂 Current document content length: \(document.content.count)")
        ...
        do {
            ...
            print("📂 Read content length: \(content.count)")
            
            document = DocumentModel(content: content, fileURL: url)
            print("📂 Document updated - fileURL: \(document.fileURL?.lastPathComponent ?? "nil"), content length: \(document.content.count)")
            ...
            print("✅ Document content preview: \(String(document.content.prefix(100)))")
        } catch {
